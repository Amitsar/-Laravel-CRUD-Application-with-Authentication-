...
<div class="max-w-3xl mx-auto px-6 py-12">
    <h2 class="text-3xl font-bold text-gray-800 mb-8 border-b pb-4">✏️ Edit Product</h2>
    ...
    <form method="POST" action="{{ route('products.update', $product->id) }}" class="bg-white p-6 rounded-xl shadow-lg space-y-6">
        ...
        <div class="flex justify-between">
            ...
            <button class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg font-semibold">💾 Update Product</button>
        </div>
    </form>
</div>
@endsection
